...
<head>
	...
	<title><?php echo constant('SYS_NAME');?>|添加商品</title>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo site_url("sys/admin_vip/add_show")?>">新增充值</a>
								<span class="icon-angle-right"></span>
							</li>
						</ul>
					</div>
					...
					<div class="span12">
						<div class="portlet box myself">
							...
							<div class="portlet-body form">
								<form action="<?php echo site_url("sys/admin_vip/add");?>" class="form-horizontal" method="post" 
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span6 m-wrap" style="width:500px;" name="v_name" id="v_name"/>
									...
									<div class="control-group" >
										...
										<div class="controls">
											<textarea style="width:485px;" name="v_desc" id="v_desc"></textarea>
									...
									<div class="control-group" >
										...
										<div class="controls">
                                        	<input type="text" class="span2 m-wrap"  placeholder="只能填写数字" style="float:left;width:200px;" name="v_old_money" id="v_old_money"/>
                                    ...
                                    <div class="control-group" >
										...
										<div class="controls">
                                        	<input type="text" class="span2 m-wrap"  placeholder="只能填写数字" style="float:left;width:200px;" name="v_money" id="v_money"/>
                                            <span style="float:left;margin-top:5px;display:block;color:#999999;">&nbsp;元&nbsp;<font id="old_price"></font>&nbsp;&nbsp;</span>
                                    ...
                                    <div class="control-group" >
										...
										<div class="controls">
                                        	<input type="text" class="span2 m-wrap"  placeholder="只能填写数字" style="float:left;width:200px;" name="v_month" id="v_month"/>
                                    ...
                                    <div class="control-group" >
										...
										<div class="controls">
                                        	<input type="text" class="span2 m-wrap"  placeholder="只能填写数字" style="float:left;width:200px;" name="v_add_month" id="v_add_month" value='0'/>
                                            <span style="float:left;margin-top:5px;display:block;color:#999999;">&nbsp;月&nbsp;<font id="old_price"></font>&nbsp;&nbsp;</span>
