...
<head>
	...
	<title><?php echo constant('SYS_NAME');?>|系统后台</title>
	...
	<div class="content">
		<form class="form-vertical login-form" id="login_form" action="" onsubmit="return login_submit();">
			...
			<div class="form-actions">
				...
				登陆系统<i class="m-icon-swapright m-icon-white"></i>
				</button>            
			</div>
...
function login_submit(){
	    if($("#username").val()!="" && $("#password").val()!=""){
		    var action ="<?php echo site_url('sys/admin_index/login')?>";
				...
				success: function(data)
				{
					if(data=='0'){
						...
						$("#username").focus();
					        ...
					        $("#alert_login").html("您的账户已被暂停，请联系我们客服.");
				        	$('.alert-danger', $('.login-form')).show();
							$("#username").val("");
							$("#password").val("");
					 }else{
				    	location.href ="<?php echo site_url('sys/admin_index/system')?>";
					 }
