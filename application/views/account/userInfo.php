            ...
            <div class="ibox float-e-margins">
                <form method="get" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <label class="control-label" style="font-weight:normal;"><?php echo $user['reg_num']?></label>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="hidden form-control" value="{{data.user.shop_name}}"/>
                            <label class="control-label" style="font-weight:normal;">{{data.user.shop_name ? data.user.shop_name : '未设置'}}</label>
                        </div>
                        <div class="col-md-4">
