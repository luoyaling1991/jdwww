...
<head>
	...
	<title><?php echo constant('SYS_NAME');?>|发布新品</title>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo site_url("admin/admin_dish/dish_add_show")?>">发布新品</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box myself">
							<div class="portlet-title">
								<div class="caption">&nbsp;&nbsp;&nbsp;发布新品</div>
							</div>
							<div class="portlet-body form">
								<form action="<?php echo site_url("admin/admin_dish/dish_add");?>" class="form-horizontal" method="post" onsubmit="return check_submit();" enctype='multipart/form-data'>
									<div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>菜品名称：</label>
										<div class="controls">
											<input type="text" class="span4 m-wrap" style="width:500px;" name="dish_name" id="dish_name" onchange="name_check();"/>
									...
									<div class="control-group">
										...
										<div class="controls">
                                              	<input type="text" class="span2 m-wrap"  style="float:left;width:200px;" name="dish_price" id="dish_price"/>
									...
									<div class="control-group">
										...
										<div class="controls">
                                        	<textarea class="span6 m-wrap" style="width:500px;height:90px; 
                                            		max-width: 500px;max-height: 90px;" name="dish_desc" id="dish_desc"></textarea>
									...
									<div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="sys_type" value="1" onChange="check_ed();" checked/>菜
											</label>
                                            <select class="check_ed_class"  name="sys_type_1" id="sys_type_1"
                                            	style="margin-left:-10px;margin-top:-15px;width:80px;font-size:12px;height:26px;">
                                                        <option value="0">不限</option>
                                                        <option value="1">荤菜</option>
                                                        <option value="2">素菜</option>
                                            </select>
                                            <select class="check_ed_class" name="sys_type_2" id="sys_type_2"
                                             style="margin-right:15px;margin-top:-15px;width:80px;font-size:12px;height:26px;">
                                                    	<option value="0">不限</option>
                                                        	...
                                                        	<tr>
                                                            	<td>
                                                                   <div class="div_class_img_small border_red">
                                                                        	<img src="<?php echo constant('ADMIN_SRC');?>media/upload/dish_1.png" style="width:136px;height:100px;" 
                                                                ...
                                                                <td>
                                                                	<div class="div_class_img_small">
                                                                        	<img src="<?php echo constant('ADMIN_SRC');?>media/upload/dish_2.png" style="width:136px;height:100px;" 
                                                                	...
                                                                	<div class="div_class_img_small">
                                                                        	<img src="<?php echo constant('ADMIN_SRC');?>media/upload/dish_2.png" style="width:136px;height:100px;" 
                                                                        		class="tooltips" id="img_3"
                                                                            	 />
                                                                            	 <input type="hidden" id="value_3" name="value_3">
                                                                         <div class="div_class_img_small_a">
                                                                	...
                                                                	<div class="div_class_img_small">
                                                                        	<img src="<?php echo constant('ADMIN_SRC');?>media/upload/dish_2.png" style="width:136px;height:100px;" 
                                                                        		class="tooltips" id="img_4"
                                                                            	 />
                                                                            	 <input type="hidden" id="value_4" name="value_4">
                                                                         <div class="div_class_img_small_a">
                                                                	...
                                                                	<div class="div_class_img_small">
                                                                        	<img src="<?php echo constant('ADMIN_SRC');?>media/upload/dish_2.png" style="width:136px;height:100px;" 
                                                                        		class="tooltips" id="img_5"
                                                                            	 />
                                                                            	 <input type="hidden" id="value_5" name="value_5">
                                                                         <div class="div_class_img_small_a">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="dish_state" value="1" checked/>立即上架
											</label>
                                            <label class="radio">
												<input type="radio" name="dish_state" value="0" />暂不上架
											</label>
                                        </div>
                                     </div>
                                     <div class="control-group">
		...
		function name_check(){
			if($("#dish_name").val()==""){
				...
				if($("#dish_name").val().length>6){
					...
					$.post('<?php echo site_url('admin/admin_dish/check_name')?>',{dish_name:dish_name,dish_id:0},function (data){
						data=eval(data);
						if(data==0){
							$("#dish_name").focus();
							name_ok=0;
