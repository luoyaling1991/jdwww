...
<head>
	...
	<title><?php echo constant('SYS_NAME');?>|编辑工号</title>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo site_url("admin/admin_waiter/waiter_upd?waiter_id=").$waiter['waiter_id'];?>">编辑工号</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box myself">
							<div class="portlet-title">
								<div class="caption">&nbsp;&nbsp;&nbsp;编辑工号</div>
							</div>
							<div class="portlet-body form">
								<form action="<?php echo site_url("admin/admin_waiter/waiter_upd");?>" method="post" onsubmit="return check_submit();" class="form-horizontal">
									<div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>员工编号：</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap"  style="float:left;width:400px;" name="waiter_no" id="waiter_no" value="<?php echo $waiter['waiter_no']?>"/>
											<span class="help-inline" id="waiter_no_1">员工编号请控制在6个字符以内.</span>
											<input type="hidden" name="waiter_id" id="waiter_id" value="<?php  echo $waiter['waiter_id'];?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>员工姓名：</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap" style="float:left;width:400px;" name="waiter_name" id="waiter_name" value="<?php echo $waiter['waiter_name']?>"/>
									...
									<div class="control-group">
										...
										<div class="controls">
                                        	<input type="text" class="span6 m-wrap" style="float:left;width:400px;" name="waiter_phone" id="waiter_phone" value="<?php echo $waiter['waiter_phone']?>"/>				
										</div>
									</div>
                                    <div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="waiter_state" value="1" <?php if($waiter['waiter_state']==1) echo "checked";?>/>立即启用
											</label>
                                            <label class="radio">
												<input type="radio" name="waiter_state" value="0" <?php if($waiter['waiter_state']==0) echo "checked";?>/>暂不启用
											</label>
                                        </div>
                                     </div>
                                    <div class="control-group">
