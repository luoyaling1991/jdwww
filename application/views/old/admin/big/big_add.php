				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo site_url("admin/admin_big/big_add_show")?>">添加推荐</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box myself">
							...
							<div class="portlet-body form">
								<form action="<?php echo site_url("admin/admin_big/big_add");?>" class="form-horizontal" method="post" onsubmit="return check_submit();" enctype='multipart/form-data'>
                                	<div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>推荐类型：</label>
										<div class="controls">
											<label class="radio">
												<input type="radio" name="show_type" value="0" onChange="choose_1();" checked/>活动推荐
											</label>
                                            <label class="radio">
												<input type="radio" name="show_type" value="1" onChange="choose_2();" />菜品推荐
											</label>
                                            <label class="radio">
												<input type="radio" name="show_type" value="2" onChange="choose_3();" />套餐推荐
											</label>
									...
									<div class="control-group" name="activity_name">
										...
										<div class="controls">
											<input type="text" class="span6 m-wrap" style="width:500px;" name="show_name" id="show_name"/>
                                    ...
                                    <div class="control-group" name="dish_name" style="display:none;">
										...
										<div class="controls">
                                        	<input type="text" class="span2 m-wrap"  placeholder="只能填写数字" style="float:left;width:200px;" name="dish_price" id="dish_price"/>
                                    ...
                                    <div class="control-group" style="margin-top:-20px" name="pic_big">
										...
										<div class="controls">
                                        	<div style="margin-top:15px;background-color:#D2D2D2;width:500px;height:150px;">
                                                <img src="<?php echo constant('ADMIN_SRC');?>media/upload/dish_4.png" style="margin-left:15px;margin-top:15px;
                                                    width:360px;height:120px;" class="tooltips" id="big_img_1"/>
                                                    <input type="hidden" name="big_img_1_value" id="big_img_1_value" value=""/>
									...
									<div class="control-group" name="activity_name">
										...
										<div class="controls">
                                        	<textarea class="span6 m-wrap" style="width:500px;height:150px;
                                            	max-width: 500px;max-height: 150px;" name="show_desc" id="show_desc"></textarea>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="show_state" value="1" checked/>立即发布
											</label>
                                            <label class="radio">
												<input type="radio" name="show_state" value="0" />暂不发布
											</label>
                                        </div>
                                     </div>
                                    <div class="control-group">
										<div class="controls">
											<input type="hidden" id="big_img" name="big_img" value=""/>
											<input type="hidden" id="dish_id" name="dish_id" value=""/>
											<input type="hidden" id="set_id" name="set_id" value=""/>
											<input type="hidden" id="dish_type_id" name="dish_type_id" value="<?php echo $type_id;?>"/>
...
function ajaxFileUpload(){
		$("#big_img_1").attr("src","<?php echo constant('ADMIN_SRC');?>media/upload/83.gif"); 
	    $.ajaxFileUpload(
	    {
