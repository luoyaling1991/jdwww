					...
					<div class="span12">
						<div class="portlet box myself border_none">
							...
							<div class="portlet-body form ">
								<form action="<?php echo site_url("admin/admin_type/type_add");?>" method="post" onsubmit="return check_submit();" class="form-horizontal">
									<div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>分类名称：</label>
										<div class="controls">
											<input type="text" class="span4 m-wrap" style="width:500px;" name="type_name" id="type_name"/>
                                    ...
                                    <div class="control-group">
										...
										<input type="hidden" name="set_list" id="set_list" value=""/>
                                        	<div  style="float:left;width:340px;">
												...
												<div style="width:99.5%;height:230px;border:1px #ccc solid;overflow-y:auto;" id="height_div_1">
											...
											<div style="float:left;width:300px;">
												...
												<div style="width:99.3%;height:230px;border:1px #ccc solid;overflow-y:auto;"  id="height_div_2">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="type_state" value="1" checked/>立即启用
											</label>
                                            <label class="radio">
												<input type="radio" name="type_state" value="0" />暂不启用
											</label>
                                        </div>
                                     </div>
                                     <div class="control-group">
