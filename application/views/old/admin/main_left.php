<nav class="navbar-default navbar-static-side" role="navigation">
	<div class="sidebar-collapse">
		<ul class="nav" id="side-menu">
			<li class="active">
				<a href="javascript:void(0);" onclick="setContentUrl('<?php echo site_url('admin/admin_index/main_right')?>')"><i class="fa fa-th-large"></i> <span class="nav-label">账户信息</span></a>
			</li>
			<li>
				...
				<ul class="nav nav-second-level">
					...
					<li><a href="javascript:void(0);" onclick="setContentUrl('<?php echo site_url('admin/admin_big/big_list')?>')">推荐管理</a>
					</li>
