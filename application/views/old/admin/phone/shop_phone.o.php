    ...
    function get_num(num){
        ...
        if(num==2){
            ...
            if(shop_email_1==""){
                ...
                if(shop_email_1==shop_mail){
                    //异步传输获取验证码
                    $.post('<?php echo site_url('admin/admin_phone/get_num')?>', {data:shop_mail,type:num }, function (e) {
                        if (e==-1){
        ...
        }else//手机验证
        {
            ...
            if(shop_phone_1==shop_phone){
                //异步传输获取验证码
                $.post('<?php echo site_url('admin/admin_phone/get_num')?>', {data:shop_phone,type:num }, function (e) {
                    if (e==-1){
        ...
        if(num==1){//短信验证
            if(check_phone==""){
                ...
                if(parseInt(check_phone)!==parseInt(log_txt_1)){
                    ...
                    window.location.href="<?php echo site_url("admin/admin_phone/upd_phone_show");?>";
                }
            }
        }else{//邮箱验证
            if(check_email==""){
