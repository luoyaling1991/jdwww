...
<div >
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo site_url("admin/admin_set/set_delete?set_id=").$set['set_id'];?>">发布套餐</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box myself border_none">
							<div class="portlet-title">
								<div class="caption">&nbsp;&nbsp;&nbsp;编辑套餐</div>
							</div>
							<div class="portlet-body form ">
								<form action="<?php echo site_url("admin/admin_set/set_update");?>" class="form-horizontal" method="post" onsubmit="return check_submit();" enctype='multipart/form-data'>
									<div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>套餐名称：</label>
										<div class="controls">
											<input type="text" class="span4 m-wrap" style="width:500px;" name="set_name" id="set_name" onchange="name_check('<?php echo $set['set_id'];?>');" value="<?php echo $set['set_name'];?>"/>
											<span class="help-inline" id="set_name_1">套餐名称请控制在6个字以内.</span>
											<input type="hidden" name="set_id" id="set_id" value="<?php echo $set['set_id'];?>">
									...
									<div class="control-group">
										...
										<div class="controls">
                                        	<textarea class="span6 m-wrap" style="width:500px;height:90px;
                                            				max-width: 500px;max-height: 90px;" name="set_desc" id="set_desc"><?php echo $set['set_desc'];?></textarea>
                                    ...
                                    <div class="control-group">
                                                               ...
                                                               <tr>
                                                                 ...
                                                                 <tr>
                                                                	...
                                                                	<td style="padding-top:7px;color:#aaaaaa;">
                                                                   		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                          您需要上传<font color="e02222">1</font>张小图
                                                                          <font color="e02222">1</font>张大图。
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td></td>
                                       ...
                                       <td>
                                                                	<div class="div_class_img_small">
                                                                        <img src="<?php if($set['set_img']!=""){echo base_url().$set['set_img'];}else{ echo constant('ADMIN_SRC')."media/upload/set_1.png";}?>" style="width:136px;height:100px;" 
                                                                        		class="tooltips" id="img_1"
                                                                            	/>
                                                                         <input type="hidden" id="value_1" name="value_1" value="<?php if($set['set_img']!=""){echo $set['set_img'];}?>">
                                                                ...
                                                                <td>
                                                                	<div class="div_class_img_small_1">
                                                                    	<img src="<?php if($set['set_img_big']!=""){echo base_url().$set['set_img_big'];}else{ echo constant('ADMIN_SRC')."media/upload/set_2.png";}?>" style="width:300px;height:100px;" 
                                                                        		class="tooltips" id="img_2"
                                                                            	 />
                                                                         <input type="hidden" id="value_2" name="value_2" value="<?php if($set['set_img_big']!=""){echo $set['set_img_big'];}?>">
                                                                         <div class="div_class_img_small_a">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
                                              	<input type="text" class="span2 m-wrap"  placeholder="只能填写数字" style="float:left;width:200px;" value="<?php echo $set['set_price'];?>" name="set_price" id="set_price"/>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="set_state" value="1" <?php if($set['set_state']==1){echo "checked";}?>/>立即上架
											</label>
                                            <label class="radio">
												<input type="radio" name="set_state" value="0" <?php if($set['set_state']==0){echo "checked";}?>/>暂不上架
											</label>
                                        </div>
                                     </div>
                                     <div class="control-group">
	...
	function check_submit(){
		...
		if($("#set_name").val()==""){
			...
			if($("#set_name").val().length>6){
				$("#set_name").focus();
				$("#set_name_1").html("菜品名称请控制在6个字符以内.");
				$("#set_name_1").css("color","red");
				err_num++;
			}else{
				if(name_ok!=1){
		...
		var set_list=eval(<?php echo $set_list_json;?>);
