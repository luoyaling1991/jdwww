                    ...
                    <div class="portlet box myself">
                        ...
                        <div class="tabbable tabbable-custom boxless" style="background-color:#FFF;" >
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab_1" data-toggle="tab">通过原手机验证</a></li>
												...
												<div class="row-fluid">
														<div class="control-group">
															...
															<div class="controls">
																...
																<span class="help-inline">填写您原绑定的手机号码.</span>
															</div>
														</div>
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <input type="submit" class="btn red" value="获取验证码" id="btn_1"/>
                                                            </div>
														</div>
												</div>
												<div class="form-actions clearfix">
                                                    <a href="shop_phone_2.html" class="btn blue button-next">
                                ...
                                <div class="tab-pane" id="tab_2">
										<div class="portlet-body form" style="background-color:#fff;">
											<form action="#" class="form-horizontal">
												...
												<div class="form-actions clearfix">
                                                    <a class="btn blue button-next" onclick="check_num(&quot;2&quot;)">
                                                    继续下一步<i class="m-icon-swapright m-icon-white"></i>
                                                    </a>
                                                </div>
											</form>     
	...
	function get_num(num){		
		if(num==2){		
			...
			if(reg.test(shop_mail)){
				//异步传输获取验证码
				$.post('<?php echo site_url('admin/admin_user/get_num_2')?>', {data: shop_mail,type:num }, function (e) {
					if (e==3){
						alert('获取验证码失败，输入的原邮箱地址不正确，请重新输入');
						}
					else if(e==2){
						alert('获取验证码成，请登录邮箱查看验证码，尽快完成验证');
						timer(num);
						bl=1;
						}
					});
			...
			$.ajax
		       ({
		            ...
		            { 
			           if(e==0){
			           	bl=0;
			           	alert("验证码或邮箱输入错误或者已经过期，请重新输入或者获取验证码");
			             }else{
						bl=1;
				             }       
		            }
		        });
	      if(num==2&&bl==1&&type==2){
		      location.href="<?php echo site_url('admin/admin_user/shop_email')?>";
		      }
	      	else if(num==1&&bl==1&&type==1){
