			...
			<div class="ibox float-e-margins">
				<form method="get" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-md-6">
							<div class="radio i-checks radio-inline" style="margin-right:20px;">
								<input type="radio" value="01" name="type">
								&nbsp;&nbsp;200元/月
							</div>
							<div class="radio i-checks radio-inline" style="margin-right:20px;">
								<input type="radio" value="02" name="type">
								&nbsp;&nbsp;1000元/半年
							</div>
					...
					<div class="form-group">
						...
						<div>
							<label class="control-label text-danger col-md-1" style="font-weight:normal;">200 元</label>
						</div>
					</div>
