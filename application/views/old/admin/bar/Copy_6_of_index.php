		...
		$.each(type_list,function(i1, item1){
			...
			$.each(tab_one_list,function(i2, item2){
				...
				if(tab_state==2){
	                ...
	                $("#tbody_2").html();
	                var tbody_2_html="<tr>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"'>01</a></td>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"'>1楼大厅001</a></td>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"'>18:34:23</a></td>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"' style='color:#F00;'>1580.00</a></td>";
	                	tbody_2_html+="</tr>";
