...
<body class="page-header-fixed">
	...
	function ajax_get(){
		$.ajax({
			       url:'<?php echo site_url("admin/admin_bar/ajax")?>',
			       type: "POST",
			       data:{},
			       dataType: "json", 
			       error: function(){  
		...
		$.each(type_list,function(i1, item1){
			...
			$.each(tab_one_list,function(i2, item2){
				...
				if(tab_state==2){
					...
					order_show_div_html+="		<button type='button' class='close' data-dismiss='modal' aria-hidden='true'></button>";
					...
					order_show_div_html+="	<div class='modal-body' style='background-color:#F5F5F5;height:300px;'>";
					...
					$.each(order_list,function(i3, item3){
						...
						$.each(log_list,function(i4, item4){
							...
							var log_money=item4.log_money;
							    ...
							    order_show_div_html+="            <a href='#' class='btn_a_del'>";
					...
					order_show_div_html+="        		<input type='text' style='color:#000;font-weight:bold;margin-top:10px;height:20px;width:100px;'/>";
					order_show_div_html+="  			</td>";
					order_show_div_html+="   		<td style='width:45px'>";
					...
					order_show_div_html+="       		<b>差额&nbsp;&nbsp;&nbsp;-212元</b>";
					order_show_div_html+="  			</td>";
					order_show_div_html+=" 		</tr>";
					order_show_div_html+=" 		<tr>";
					order_show_div_html+="          	<td >";
					...
					order_show_div_html+="					<input type='checkbox' value='' />抹零";
					order_show_div_html+="  				</label>";
					order_show_div_html+="   			<label class='checkbox' style='margin-top:5px;float:left;width:110px;'>";
					order_show_div_html+="					<input type='checkbox' value='' />活动减免";
					order_show_div_html+="  				</label>";
					order_show_div_html+=" 				<label class='checkbox' style='margin-top:5px;float:left;width:110px;'>";
				    order_show_div_html+="					<input type='checkbox' value='' />会员折扣";
				    order_show_div_html+="			  	</label>";
				    order_show_div_html+="              	<label class='checkbox' style='margin-top:5px;float:left;width:88px;'>";
				    order_show_div_html+="					<input type='checkbox' value='' />免单";
					order_show_div_html+="			  	</label>";
					order_show_div_html+="            	<label class='checkbox' style='margin-top:5px;float:left;width:88px;'>";
					order_show_div_html+="					<input type='checkbox' value='' />签单";
					order_show_div_html+="		 		</label>";
					order_show_div_html+="           	<label class='checkbox' style='margin-top:5px;float:left;width:88px;'>";
					order_show_div_html+="					<input type='checkbox' value='' />其它";
					order_show_div_html+="	  			</label>";
					order_show_div_html+="   	  </td>";
					order_show_div_html+="	</tr>";
					order_show_div_html+=" 	<tr>";
	                ...
	                order_show_div_html+=" 		</td>";
	                order_show_div_html+="     	<td colspan='4'>";
	                order_show_div_html+="			<input type='text' style='color:#000;font-weight:bold;margin-top:10px;height:20px;width:530px;'/>";
	                order_show_div_html+="    	</td>";
	                order_show_div_html+="	</tr>";
	                order_show_div_html+="  	<tr>";
	                ...
	                order_show_div_html+="		<td >&nbsp;</td>";
	                order_show_div_html+=" 		<td colspan='4'>";
	                order_show_div_html+="      		<button type='submit' style='margin-top:5px;' class='btn_1' >结账</button>&nbsp;&nbsp;&nbsp;&nbsp;";
	                order_show_div_html+="   		<button type='submit' style='margin-top:5px;' class='btn_2' >重置所有</button>";
	                order_show_div_html+="    	</td>";
	                order_show_div_html+="	</tr>";
	                order_show_div_html+="</table>";
	                ...
	                var tbody_2_html="<tr>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"' style='color:#000;'>"+order_now_num_show+"</a></td>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"' style='color:#000;'>"+type_name+tab_name+"</a></td>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"' style='color:#000;'>"+insert_time_no1+"</a></td>";
	                	tbody_2_html+="<td ><a  data-toggle='modal' href='#show_order_"+tab_id+"' style='color:#000;'>"+order_money+"</a></td>";
	                	tbody_2_html+="</tr>";
