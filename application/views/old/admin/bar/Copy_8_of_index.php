		...
		$.ajax({
		       ...
		       success: function(data,status){//如果调用php成功    
		    	   ...
		    	   try {  
			         ...
			         wdapp.Documents.Open("<?php echo constant('ADMIN_SRC')."mb002.docx";?>"); //打开本地(客户端)word模板
			         wddoc = wdapp.ActiveDocument;  
			         wddoc.Bookmarks("print_name").Range.Text =print_data['print_name'];
			         wddoc.Bookmarks("order_no").Range.Text = print_data['order_no'];
			         wddoc.Bookmarks("insert_time").Range.Text = print_data['insert_time'];
			         ...
			         wddoc.Bookmarks("sum").Range.Text =sum";
