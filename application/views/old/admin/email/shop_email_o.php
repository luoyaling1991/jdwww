        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo site_url('admin/admin_email/upd_email_show');?>">更换绑定邮箱</a></li>
                </ul>
            </div>
        </div>
        <div class="row-fluid">
                ...
                <div class="portlet box myself">
                    ...
                    <div class="tabbable tabbable-custom boxless" style="background-color:#FFF;" >
                        <ul class="nav nav-tabs">
                            ...
                            <li><a class="" href="#tab_2" data-toggle="tab">通过原邮箱验证</a></li>
                        </ul>
    ...
    function get_num(num){
        if(num==2){
            ...
            if(shop_email_1==""){
                ...
                if(shop_email_1==shop_mail){
                    //异步传输获取验证码
                    $.post('<?php echo site_url('admin/admin_email/get_num')?>', {data: shop_mail,type:num }, function (e) {
                        if (e==-1){
        ...
        }else//手机验证
        {
            ...
            if(shop_phone_1==shop_phone){
                //异步传输获取验证码
                $.post('<?php echo site_url('admin/admin_email/get_num')?>', {data:shop_phone,type:num }, function (e) {
                    if (e==-1){
        ...
        if(num==1){//短信验证
            if(check_phone==""){
                ...
                if(parseInt(check_phone)!=log_txt_1){
                    ...
                    window.location.href="<?php echo site_url("admin/admin_email/upd_email_show_1");?>";
                }
            }
        }else{//邮箱验证
            if(check_email==""){
