...
<head>
	...
	<title><?php echo constant('SYS_NAME');?>|餐桌编辑</title>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo site_url("admin/admin_table/table_delete?tab_id=").$table['tab_id'];?>">餐桌编辑</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box myself">
							<div class="portlet-title">
								<div class="caption">&nbsp;&nbsp;&nbsp;餐桌编辑</div>
							</div>
							<div class="portlet-body form">
								<form action="<?php echo site_url("admin/admin_table/table_update")?>" class="form-horizontal" method="post" onsubmit="return check_submit();">
									
									<div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>餐桌桌号：</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap" style="width:500px;" name="tab_name" id="tab_name" value="<?php echo $table['tab_name'];?>"/>
											<span class="help-inline" id="tab_name_1">餐桌桌号请控制在4个字以内.</span>
											<input type="hidden" name="tab_id" value="<?php echo $table['tab_id'];?>">
										</div>
									</div>
                                    <div class="control-group">
										<label class="control-label"><span class="required">*&nbsp;</span>容客人数：</label>
										<div class="controls">
											<input type="text" class="span2 m-wrap"   style="float:left;width:200px;" name="tab_person" id="tab_person" value="<?php echo $table['tab_person'];?>"/>
									...
									<div class="control-group">
										...
										<div class="controls">
                                                	<input type="text" class="span2 m-wrap"   style="float:left;width:200px;" name="tab_price" id="tab_price" value="<?php echo $table['tab_price'];?>"/>
										...
										<div class="controls">
                                        	<select  style="width:200px;" name="type_id" id="type_id">
                                        			<?php 
                                        			    ...
                                        			    $type_id_1=$table['type_id'];
                                        				foreach ($type_list as $row){
                                        					$type_id=$row['type_id'];
                                        					$type_name=$row['type_name'];
                                        					if($type_id_1==$type_id){
                                        						echo "<option value='$type_id'>$type_name</option>";
                                        					}
                                        				}
                                        				foreach ($type_list_1 as $row){
                                        					$type_id=$row['type_id'];
                                        					$type_name=$row['type_name'];
                                        					if($type_id_1!=$type_id){
                                        						echo "<option value='$type_id'>$type_name</option>";
