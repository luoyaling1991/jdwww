				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo site_url("admin/admin_table/table_type_add_show")?>">添加餐桌分类</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box myself">
							<div class="portlet-title">
								<div class="caption">&nbsp;&nbsp;&nbsp;添加餐桌分类</div>
							</div>
							<div class="portlet-body form">
								<form method="post" action="<?php echo site_url("admin/admin_table/table_type_add")?>" onsubmit="return check_submit();" class="form-horizontal">
									<?php 
										if($tishi!=""){
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span6 m-wrap"  style="width:500px" name="type_name" id="type_name"/>
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
											<label class="radio">
												<input type="radio" name="type_state" value="1" checked/>立即上架
											</label>
                                            <label class="radio">
												<input type="radio" name="type_state" value="0" />暂不上架
											</label>
                                        </div>
                                     </div>
