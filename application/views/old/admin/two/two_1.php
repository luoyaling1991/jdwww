				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								<a href="<?php echo site_url("admin/admin_index/main_right")?>">返回系统管理</a> 
                ...
                <div class="row-fluid">
                    ...
                    <div class="portlet box myself">
                       ...
                       <div class="portlet-body form">
											<form action="<?php echo site_url("admin/admin_two/login_two_1")?>" onsubmit="return check_pwd();"  class="form-horizontal" method="post">
												<div class="row-fluid">
